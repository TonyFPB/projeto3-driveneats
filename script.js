...
function paginaFinal(){
    ...
    if(nome.value !== ''  && endereco.value  !== ''){
        ...
        let texto=`Olá,%20gostaria%20de%20fazer%20o%20pedido:%0A-%20Prato:%20${pegandoInfo()[0][0]}%0A-%20Bebida:%20${pegandoInfo()[1][0]}%0A-%20Sobremesa:%20${pegandoInfo()[2][0]}%0ATotal:%20R$%20${Total}%0ANome:%20${Nome1}%0AEndereço:%20${Endereco1}`
